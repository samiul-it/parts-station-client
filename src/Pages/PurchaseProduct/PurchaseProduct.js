...
const PurchaseProduct = () => {
    ...
    const {img,productName,price,description,stock,minOrder}=productDetail;
    ...
    const onSubmit = (data) => {
        ...
        const stockUpdate=currentStock- orderQty;
         ...
         const orderDetails = {id,orderQty,userEmail};
        ...
        <div className="grid lg:grid-cols-2 my-10 justify-center mx-10 mb-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {errors.order && errors.order.type === "min" && (
              <span className="text-red-800">Minumum Order {minOrder} Pcs</span>
            )}
            {errors.order && errors.order.type === "max" && (
              <span className="text-red-800">Max Stock {currentStock} Pcs</span>
            )}
            <br />
